...
def main(path, out_path, framerate, dims):
    ...
    while True:
        ...
        lines = create_grid_mask(warped_rgb, vertical_lines, horizontal_lines)
        warped_inverse = inverse_perspective(lines, frame.copy(), np.array(corners))
...
if __name__ == '__main__':
    main('b.mp4', 'grid.avi', 30.0, (1920, 1080))